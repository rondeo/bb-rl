                    ...
                    <div className="col-12 col-md-6 offset-md-3">
                        ...
                        <form onSubmit={this.onSubmit}>
                            <div className="form-group">
                                ...
                                <input type="email" className="form-control" id="mail" aria-describedby="mailHelp"
                                       placeholder="E-Mail-Adresse"/>
                                <small id="mailHelp" className="form-text text-muted">Wir werden deine E-Mail-Adresse
                            ...
                            <div className="form-group">
                                ...
                                <input type="password" className="form-control" id="password1" placeholder="Passwort"
                                       required/>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-check">
                                ...
                                <label className="form-check-label" htmlFor="exampleCheck1">Bitte akzeptiere
                                    unsere <Link to="/datenschutz"
                                                 target="_blank">Datenschutzbestimmungen</Link>.</label>
                            </div>
