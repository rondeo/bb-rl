        ...
        return (
            <div className="view full-container my-profile">
                <div className="container">
                    <p><h1>Mein Profil</h1></p>
                    <label for="person">Persönliche Informationen</label>
                    ...
                    <label htmlfor="inputGame">
Gaming Informationen
</label>

                    <div className="form-row">
                        <div className="form-group col-md-5">
                            <label htmlFor="inputPlattform1">
Plattform 1:
</label>
                    ...
                    <hr color="white" width="100%"/>
                    <div className="form-row">
                        <button type="button" class="btn white" wfd-id="69">Speichern</button>
                        <button type="reset" class="btn white" wfd-id="69">Zurücksetzen</button>
                    </div>
                </div>
            </div>
        )
